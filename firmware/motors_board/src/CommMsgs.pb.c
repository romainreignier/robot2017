...
const pb_field_t snd_msgs_Status_fields[7] = {
    PB_FIELD(  1, MESSAGE , REQUIRED, STATIC  , FIRST, snd_msgs_Status, pose, pose, &snd_msgs_Pose_fields),
    PB_FIELD(  2, MESSAGE , REQUIRED, STATIC  , OTHER, snd_msgs_Status, speed, pose, &snd_msgs_Speed_fields),
    ...
    PB_FIELD(  5, MESSAGE , REQUIRED, STATIC  , OTHER, snd_msgs_Status, ir, estop, &snd_msgs_Ir_fields),
    PB_FIELD(  6, MESSAGE , REQUIRED, STATIC  , OTHER, snd_msgs_Status, encoders, ir, &snd_msgs_Encoders_fields),
    PB_LAST_FIELD
};
