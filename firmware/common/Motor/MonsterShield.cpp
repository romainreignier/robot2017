...
MonsterShield::MonsterShield(PWMDriver* _driver, const uint32_t _timerFrequency,
  ...
  : Motor{_driver,
    ...
    m_CWGpio{_CWGpio}, m_CWPin{_CWPin}, m_CCWGpio{_CCWGpio}, m_CCWPin{_CCWPin},
    m_ENGpio{_ENGpio}, m_ENPin{_ENPin}
{
}
